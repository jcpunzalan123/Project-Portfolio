...
|---------------------------------------|---------------------------------------|----------------|-----------------|
| Analyzing financial reports using Local LLM | [DigiPlus Financial Reports](https://edge.pse.com.ph/financialReports/form.do)  | Extract insights from financial data of a public company in PSE   |   Stock Market, Large Language Models (LLM), Analysis     |
